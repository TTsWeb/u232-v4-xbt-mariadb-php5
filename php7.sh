...
apt-get -y update
apt-get -y install mariadb-server memcached unzip libssl-dev php7.0 php7.0-mysql php7.0-json locate php7.0-fpm php7.0-dev git pkg-config build-essential nginx libmemcached-dev
...
rm /var/www/include/classes/class_cache.php
wget https://gitlab.open-scene.net/whocares/u232-v4-xbt-mariadb-php5/raw/master/class_cache.php -O /var/www/include/classes/class_cache.php
